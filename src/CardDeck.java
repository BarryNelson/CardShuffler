...
/**
 * CardDeck represents a deck of 52 playing cards
 * cards have the values 0 (ace) through 12 (king)
 * 
 * @author Barry Nelson
 *
 */
public class CardDeck {
	...
	class CNode {
		...
		/**
		 * set a card into the nextCard
		 * replaces whatever may have been there
		 * 
		 * @param nextNode
		 */
	 ...
	 * method:
	 *  a group of cards is separated from the top of the deck
	 *  and placed at the end of the next "stripe" of cards removed from the new top of the deck
	 *  this procedure repeats until the original deck is exhausted
	 * 
	 * 
	 * @param stripe
	 */
	...
	/**
	 * riffleShuffle is the most common form of shuffling cards
	 * method:
	 * deck is stripeShuffled
	 * then
	 * deck is cut into two decks randomly
	 * those two decks are merged via shuffleMerge
	 * 
	 * @param i
	 */
	...
	/**
	 * merges second CNode deck into first 
	 * method:
	 * a random number of cards are "cut" from the top of both decks
	 * one group goes below the other
	 * repeat through the remainder of both decks
	 * 
	 * @param deck1
	 * @param deck2
	 * @param interleave 
